...
function Header() {
  ...
  const handleRegisterSubmit = async (event) => {
    ...
    try {
        const response = await fetch('https://movies-plateform.vercel.app/api/register', { // Updated URL for Vercel
            method: 'POST',
...
const handleLoginSubmit = async (event) => {
    ...
    try {
        const response = await fetch('https://movies-plateform.vercel.app/api/login', { // Updated URL for Vercel
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
